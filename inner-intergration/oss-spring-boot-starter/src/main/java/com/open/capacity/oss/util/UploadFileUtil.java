package com.open.capacity.oss.util;
...
public class UploadFileUtil {
    ...
    public static String uploadFile(MultipartFile file, String filePath, String fileName, String host) throws IOException {
        InputStream inputStream = file.getInputStream();
        byte[] bytes = IOUtils.toByteArray(inputStream);
        return uploadFileByBytes(bytes,filePath, fileName,host);
    }

    public static String uploadFileByBytes(byte[] bytes, String filePath,String fileName,String host) throws IOException {
        ...
        try {
            ...
            if (System.getProperty("os.name").toLowerCase().contains("windows")) {
                ...
                uploadPath = "/web/upload/"+filePath+"/" + File.separator + directory;
            ...
            fop.flush();
            fop.close();
            return host+"/"+filePath + File.separator + directory + File.separator + fileName;
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
            fop.close();
