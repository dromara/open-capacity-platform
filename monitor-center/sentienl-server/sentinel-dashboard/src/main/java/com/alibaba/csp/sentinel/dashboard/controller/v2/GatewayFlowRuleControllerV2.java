...
public class GatewayFlowRuleControllerV2 extends InDataSourceRuleStore<GatewayFlowRuleEntity>{
...
//        GatewayFlowRuleEntity entity = repository.findById(id); 内存获取数据
        // 远端获取数据
