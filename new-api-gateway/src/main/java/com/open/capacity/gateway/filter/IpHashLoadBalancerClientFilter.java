...
import com.open.capacity.gateway.loadbalancer.IpHashLoadBalancer;
...
public class IpHashLoadBalancerClientFilter implements GlobalFilter, Ordered {
	...
	public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
		...
		if ( url != null && (CommonConstant.HASH_LB.equals(url.getScheme()) || CommonConstant.HASH_LB.equals(schemePrefix))) {
