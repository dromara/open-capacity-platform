/*
	软件名称：ckplayer for Layui
	软件版本：X2
	软件作者：niandeng and TimVan
	软件网站：http://www.ckplayer.com
	** 根据ckplayer进行二次开发，使得项目适应layui
	** 新增 baseUrl 属性，作为默认的请求路径
	--------------------------------------------------------------------------------------------------------------------
	开发说明：
...
layui.define('jquery', function(exports) {
	...
	var ckplayer = function(obj) {
		...
		*/
		...
		this.playbackRateArr = [[0.75, '0.75X'], [1, '正常'], [1.25, '1.25X'], [1.5, '1.5X'], [2, '2X']];
		//全局变量：保存倍速
	...
	ckplayer.prototype = {
		...
		*/
		embed: function(c) {
			...
			this.baseUrl=this.vars['baseUrl'];
			this.checkUpConfig();	
		},
		/*
			内部函数
		...
		*/
		controlBarHide: function(hide) {
			...
			this.timerCBar = new this.timer(1500, cbarFun);
